...
| `excludeTags` | The storybook tags to prevent from creating badges.                                                      | [Using Tags](./using-tags)                         |
| `locations`   | Default locations for badges to display                                                                  | [Badge Locations](./badge-locations.mdx)           |
| `useTags`     | Whether to use storybook's [tags](https://storybook.js.org/docs/writing-stories/tags) to generate badges | [Using Tags](./using-tags)                         |
