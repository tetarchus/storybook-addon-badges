...
This does not apply when adding the config to the manager config file, as the config is not
extendable, and all badges should be defined at the global level.
