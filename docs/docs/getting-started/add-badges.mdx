...
The `badges` parameter accepts an array of strings relating to badge names. The may be any of the [pre-defined badges](@todo), [custom badges](@todo), or any string which will inherit the [default styles](@todo) if not defined.
