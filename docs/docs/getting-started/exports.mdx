...
| `BadgesConfig`        | Type     | Type definition of the badge mapping object.                           |
| `NewBadgesConfig`     | Type     | The new configuration object with more options.                        |
...
| `BADGE_LOCATION`      | Constant | Mapping object of [badge locations](./badge-locations.mdx) names.      |
